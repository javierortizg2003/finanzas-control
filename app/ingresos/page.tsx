...
export default function IngresosPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ amount: "", category: INCOME_CATEGORIES[0], description: "", date: new Date().toISOString().split("T")[0] })
      fetchData()
    } finally {
      setSubmitting(false)
    }
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p style={{ color: "#64748B" }} className="mt-1">Registra y visualiza todas tus fuentes de ingreso</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="glass-card rounded-2xl p-6">
          <h2 className="text-lg font-semibold text-white mb-5 flex items-center gap-2">
            <Plus size={18} style={{ color: "#10B981" }} /> Agregar Ingreso
          </h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                type="date" required className="input-dark"
                value={form.date}
